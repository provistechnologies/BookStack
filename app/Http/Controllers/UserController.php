...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validationRules = [
            ...
            'first_ref_name'      => ['required'],
            'first_ref_contact'   => ['required', 'regex:/^([0-9\s\-\+\(\)]*)$/','min:10', 'max:10'],
            'second_ref_name'     => ['required'],
            'second_ref_contact'  => ['required', 'regex:/^([0-9\s\-\+\(\)]*)$/','min:10', 'max:10'],
